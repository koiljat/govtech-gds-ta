...
<head>
  ...
  <title>Carpark Availability API</title>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
          ...
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Default"><a href="#api-Default">API Methods - Default</a></li>
                    <li data-group="Default" data-name="carparksAvailabilitySearchGet" class="">
                      <a href="#api-Default-carparksAvailabilitySearchGet">carparksAvailabilitySearchGet</a>
                    </li>
                    <li data-group="Default" data-name="carparksCarparkIdAvailabilityGet" class="">
                      <a href="#api-Default-carparksCarparkIdAvailabilityGet">carparksCarparkIdAvailabilityGet</a>
                    </li>
                    <li data-group="Default" data-name="carparksNearbyGet" class="">
                      <a href="#api-Default-carparksNearbyGet">carparksNearbyGet</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        <div id="project">
          <div class="pull-left">
            <h1>Carpark Availability API</h1>
          </div>
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>API to retrieve and update carpark availability information.</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Default">
                  <h1>Default</h1>
                    <div id="api-Default-carparksAvailabilitySearchGet">
                      <article id="api-Default-carparksAvailabilitySearchGet-0" data-group="User" data-name="carparksAvailabilitySearchGet" data-version="0">
                        <div class="pull-left">
                          <h1>carparksAvailabilitySearchGet</h1>
                          <p>Get Carpark Availability by Location</p>
                        </div>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/carparks/availability/search</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-carparksAvailabilitySearchGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-carparksAvailabilitySearchGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-carparksAvailabilitySearchGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://virtserver.swaggerhub.com/KOILJAT/test/1.0.0/carparks/availability/search?address="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-java">
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        String address = address_example; // String | Address to search for nearby carparks.
        try {
            array[CarparkAvailability] result = apiInstance.carparksAvailabilitySearchGet(address);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#carparksAvailabilitySearchGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-android">
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *address = address_example; // Address to search for nearby carparks.

DefaultApi *apiInstance = [[DefaultApi alloc] init];

// Get Carpark Availability by Location
[apiInstance carparksAvailabilitySearchGetWith:address
              completionHandler: ^(array[CarparkAvailability] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var CarparkAvailabilityApi = require('carpark_availability_api');

var api = new CarparkAvailabilityApi.DefaultApi()
var address = address_example; // {{String}} Address to search for nearby carparks.
...
api.carparksAvailabilitySearchGet(address, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-csharp">
...
namespace Example
{
    public class carparksAvailabilitySearchGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.carparksAvailabilitySearchGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiDefaultApi();
$address = address_example; // String | Address to search for nearby carparks.

try {
    $result = $api_instance->carparksAvailabilitySearchGet($address);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->carparksAvailabilitySearchGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;

my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $address = address_example; # String | Address to search for nearby carparks.

eval { 
    my $result = $api_instance->carparksAvailabilitySearchGet(address => $address);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->carparksAvailabilitySearchGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-carparksAvailabilitySearchGet-0-python">
...
try: 
    # Get Carpark Availability by Location
    api_response = api_instance.carparks_availability_search_get(address)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->carparksAvailabilitySearchGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">address*</td>
                                <td>
                                
                                
                                    <div id="d2e199_carparksAvailabilitySearchGet_address">
                                            ...
                                            <div class="primitive">
                                                <span class="type">
                                                    ...
                                                    <div class="inner description">
                                                        Address to search for nearby carparks.
                                                    </div>
                                            </div>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - A list of carparks and their availability returned successfully. </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-carparksAvailabilitySearchGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-carparksAvailabilitySearchGet-200-schema">
                                  <div id='responses-carparksAvailabilitySearchGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "A list of carparks and their availability returned successfully.",
  "content" : {
    "application/json" : {
      "schema" : {
        "type" : "array",
        ...
        "x-content-type" : "application/json"
                                        ...
                                        $('#responses-carparksAvailabilitySearchGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-carparksAvailabilitySearchGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-carparksAvailabilitySearchGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Default-carparksCarparkIdAvailabilityGet">
                      <article id="api-Default-carparksCarparkIdAvailabilityGet-0" data-group="User" data-name="carparksCarparkIdAvailabilityGet" data-version="0">
                        <div class="pull-left">
                          <h1>carparksCarparkIdAvailabilityGet</h1>
                          <p>Get Carpark Availability by ID</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/carparks/{carparkId}/availability</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-carparksCarparkIdAvailabilityGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-carparksCarparkIdAvailabilityGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://virtserver.swaggerhub.com/KOILJAT/test/1.0.0/carparks/{carparkId}/availability"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        String carparkId = carparkId_example; // String | The unique identifier of the carpark.
        try {
            CarparkAvailability result = apiInstance.carparksCarparkIdAvailabilityGet(carparkId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#carparksCarparkIdAvailabilityGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *carparkId = carparkId_example; // The unique identifier of the carpark.

DefaultApi *apiInstance = [[DefaultApi alloc] init];

// Get Carpark Availability by ID
[apiInstance carparksCarparkIdAvailabilityGetWith:carparkId
              completionHandler: ^(CarparkAvailability output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var CarparkAvailabilityApi = require('carpark_availability_api');

var api = new CarparkAvailabilityApi.DefaultApi()
var carparkId = carparkId_example; // {{String}} The unique identifier of the carpark.
...
api.carparksCarparkIdAvailabilityGet(carparkId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class carparksCarparkIdAvailabilityGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.carparksCarparkIdAvailabilityGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiDefaultApi();
$carparkId = carparkId_example; // String | The unique identifier of the carpark.

try {
    $result = $api_instance->carparksCarparkIdAvailabilityGet($carparkId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->carparksCarparkIdAvailabilityGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;

my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $carparkId = carparkId_example; # String | The unique identifier of the carpark.

eval { 
    my $result = $api_instance->carparksCarparkIdAvailabilityGet(carparkId => $carparkId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->carparksCarparkIdAvailabilityGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-carparksCarparkIdAvailabilityGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get Carpark Availability by ID
    api_response = api_instance.carparks_carpark_id_availability_get(carparkId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->carparksCarparkIdAvailabilityGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">carparkId*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_carparksCarparkIdAvailabilityGet_carparkId">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      String
                                                      ...
                                                      <div class="inner description">
                                                          The unique identifier of the carpark.
                                                      </div>
                                              </div>
                                                  <div class="inner required">
                                                      Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Carpark availability information returned successfully. </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-carparksCarparkIdAvailabilityGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-carparksCarparkIdAvailabilityGet-200-schema">
                                  <div id='responses-carparksCarparkIdAvailabilityGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "Carpark availability information returned successfully.",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/CarparkAvailability"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-carparksCarparkIdAvailabilityGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-carparksCarparkIdAvailabilityGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-carparksCarparkIdAvailabilityGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 404 - Carpark not found. </h3>
                      ...
                      <hr>
                    <div id="api-Default-carparksNearbyGet">
                      <article id="api-Default-carparksNearbyGet-0" data-group="User" data-name="carparksNearbyGet" data-version="0">
                        <div class="pull-left">
                          <h1>carparksNearbyGet</h1>
                          <p>Get Nearby Carparks</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/carparks/nearby</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-carparksNearbyGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-carparksNearbyGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-carparksNearbyGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-carparksNearbyGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-carparksNearbyGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://virtserver.swaggerhub.com/KOILJAT/test/1.0.0/carparks/nearby?latitude=&longitude=&radius="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        Double latitude = 1.2; // Double | Latitude of the user's current location.
        Double longitude = 1.2; // Double | Longitude of the user's current location.
        Integer radius = 56; // Integer | Search radius in kilometers.
        try {
            array[CarparkAvailability] result = apiInstance.carparksNearbyGet(latitude, longitude, radius);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#carparksNearbyGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Double *latitude = 1.2; // Latitude of the user's current location.
Double *longitude = 1.2; // Longitude of the user's current location.
Integer *radius = 56; // Search radius in kilometers.

DefaultApi *apiInstance = [[DefaultApi alloc] init];

// Get Nearby Carparks
[apiInstance carparksNearbyGetWith:latitude
    longitude:longitude
    radius:radius
              completionHandler: ^(array[CarparkAvailability] output, NSError* error) {
                            if (output) {
                            ...
                            <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var CarparkAvailabilityApi = require('carpark_availability_api');

var api = new CarparkAvailabilityApi.DefaultApi()
var latitude = 1.2; // {{Double}} Latitude of the user's current location.
var longitude = 1.2; // {{Double}} Longitude of the user's current location.
var radius = 56; // {{Integer}} Search radius in kilometers.
...
api.carparksNearbyGet(latitude, longitude, radius, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Default-carparksNearbyGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class carparksNearbyGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling DefaultApi.carparksNearbyGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiDefaultApi();
$latitude = 1.2; // Double | Latitude of the user's current location.
$longitude = 1.2; // Double | Longitude of the user's current location.
$radius = 56; // Integer | Search radius in kilometers.

try {
    $result = $api_instance->carparksNearbyGet($latitude, $longitude, $radius);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DefaultApi->carparksNearbyGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::DefaultApi;

my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $latitude = 1.2; # Double | Latitude of the user's current location.
my $longitude = 1.2; # Double | Longitude of the user's current location.
my $radius = 56; # Integer | Search radius in kilometers.

eval { 
    my $result = $api_instance->carparksNearbyGet(latitude => $latitude, longitude => $longitude, radius => $radius);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DefaultApi->carparksNearbyGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Default-carparksNearbyGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get Nearby Carparks
    api_response = api_instance.carparks_nearby_get(latitude, longitude, radius)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->carparksNearbyGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <td>
                                    ...
                                    <div id="d2e199_carparksNearbyGet_latitude">
                                        <div class="json-schema-view">
                                            <div class="primitive">
                                                <span class="type">
                                                    Double
                                ...
                                <td>
                                    ...
                                    <div id="d2e199_carparksNearbyGet_longitude">
                                        <div class="json-schema-view">
                                            <div class="primitive">
                                                <span class="type">
                                                    Double
                                ...
                                <tr><td style="width:150px;">radius*</td>
                                <td>
                                
                                
                                    <div id="d2e199_carparksNearbyGet_radius">
                                        <div class="json-schema-view">
                                            <div class="primitive">
                                                <span class="type">
                                                    Integer
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - A list of nearby carparks returned successfully. </h3>

                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-carparksNearbyGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-carparksNearbyGet-200-schema">
                                  <div id='responses-carparksNearbyGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "A list of nearby carparks returned successfully.",
  "content" : {
    "application/json" : {
      "schema" : {
        "type" : "array",
        ...
        "x-content-type" : "application/json"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-carparksNearbyGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-carparksNearbyGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-carparksNearbyGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
